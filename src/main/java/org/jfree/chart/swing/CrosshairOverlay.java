...
public class CrosshairOverlay extends AbstractOverlay implements Overlay,
    ...
    private transient CrosshairOverlayProduct crosshairOverlayProduct = new CrosshairOverlayProduct();

    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
        this.crosshairOverlayProduct = (CrosshairOverlayProduct) stream.readObject();
    ...
    public void paintOverlay(Graphics2D g2, ChartPanel chartPanel) {
        ...
        for (Crosshair ch : getDomainCrosshairs()) {
            if (ch.isVisible()) {
                ...
                if (plot.getOrientation() == PlotOrientation.VERTICAL) {
                    crosshairOverlayProduct.drawVerticalCrosshair(g2, dataArea, xx, ch);
                } else {
                    crosshairOverlayProduct.drawHorizontalCrosshair(g2, dataArea, xx, ch);
                }
            }
        }
        ...
        for (Crosshair ch : getRangeCrosshairs()) {
            if (ch.isVisible()) {
                ...
                if (plot.getOrientation() == PlotOrientation.VERTICAL) {
                    crosshairOverlayProduct.drawHorizontalCrosshair(g2, dataArea, yy, ch);
                } else {
                    crosshairOverlayProduct.drawVerticalCrosshair(g2, dataArea, yy, ch);
                }
            }
        }
    ...
    protected void drawHorizontalCrosshair(Graphics2D g2, Rectangle2D dataArea,
        ...
        crosshairOverlayProduct.drawHorizontalCrosshair(g2, dataArea, y, crosshair);
    }
    ...
    protected void drawVerticalCrosshair(Graphics2D g2, Rectangle2D dataArea,
        ...
        crosshairOverlayProduct.drawVerticalCrosshair(g2, dataArea, x, crosshair);
    }
    ...
    private void writeObject(ObjectOutputStream stream) throws IOException {
        ...
        stream.writeObject(this.crosshairOverlayProduct);
    }
}
